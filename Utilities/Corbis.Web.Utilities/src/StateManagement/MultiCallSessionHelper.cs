...
namespace Corbis.Web.Utilities.StateManagement
{
    ...
    /// making a Service Call  for each Read/Write operation.
    /// </summary>
    internal class MultiCallSessionHelper : ISessionHelper
    {
        ...
        public MultiCallSessionHelper(HttpContextBase httpContext, HttpSessionStateBase sessionBase)
        ...
        public MultiCallSessionHelper(HttpContextBase httpContext, HttpSessionStateBase httpSession, ISessionStateContract sessionState)
        {
        ...
        /// <summary>
        /// No Implementation as this class Writes data on the fly
        /// </summary>
        public void Persist() { }
