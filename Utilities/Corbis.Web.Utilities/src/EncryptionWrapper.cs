...
{
    /// <summary>
    /// Provides easy access to encryption methods.  Key is set in machine.config
    /// </summary>
    public class EncryptionWrapper
    {
        //Though this may look scary, we're using our own encryption for non-PCI data.  
        // Only cookie values for the beta site are being encrypted using this seed.
        //Darren Davis - Oct 9, 2008				 
        private const string Password = "{E1FF1E02-EB03-4DDS-B6D4-A0F5401DDCD8}";
        ...
        /// <summary>
        /// Encrypt a string into a string using a configured key 
        ...
        /// <summary>
        /// 
        /// Encrypt bytes into bytes using a configured key 
        ///    Uses Encrypt(byte[], byte[], byte[]) 
        /// </summary>
        /// <param name="clearData"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Encrypt a file into another file using a configured key 
        /// </summary>
        ...
        /// <summary>
        /// Decrypt a string into a string using a configured key 
        ...
        /// <summary>
        /// Decrypt bytes into bytes using a configured key 
        ///    Uses Decrypt(byte[], byte[], byte[])
        /// </summary>
        /// <param name="cipherData"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Decrypt a file into another file using a configured key 
        /// </summary>
        /// <param name="fileIn"></param>
        /// <param name="fileOut"></param>
        ...
        /// <summary>
        /// Encrypts the querystring portion of the URL, leaving the host information intact.
        /// </summary>
        /// <param name="urlIn"></param>
        /// <returns>The url with the querystring information encrypted.</returns>
        public static string EncryptURL(string urlIn)
        {
            int pos = urlIn.IndexOf("?");
            ...
            string returnValue = urlIn.Substring(0, pos + 1);
            string queryString = urlIn.Substring(pos + 1);
            queryString = HttpContext.Current.Server.UrlEncode(EncryptionWrapper.Encrypt(queryString));
            return string.Concat(returnValue, queryString);
        }
    }
}
