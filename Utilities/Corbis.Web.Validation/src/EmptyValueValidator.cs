...
namespace Corbis.Web.Validation
{
    ...
    /// </summary>
    public class EmptyValueValidator : ValueValidator
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public EmptyValueValidator(string messageTemplate, Type resourceType, bool negated)
        ...
        protected override void DoValidate(object objectToValidate, object currentTarget, string key, ValidationResults validationResults)
        {
            ...
            RegexValidator regexValidator = new RegexValidator(RegularExpressions.EmptyValue);
