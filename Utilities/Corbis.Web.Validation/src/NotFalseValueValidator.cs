...
namespace Corbis.Web.Validation
{
    ...
    /// </summary>
    public class NotFalseValueValidator : ValueValidator
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public NotFalseValueValidator(string messageTemplate, Type resourceType, bool negated)
        ...
        protected override void DoValidate(object objectToValidate, object currentTarget, string key, ValidationResults validationResults)
        {
            ...
            try
            {
                formValue = (objectToValidate != null) ? Convert.ToBoolean(objectToValidate) : false;
            }
            catch (Exception)
            {
                formValue = false;
