...
{
    public partial class SameModelHeader : CorbisBaseUserControl, ISameModelHeaderView
    {
        ...
        {
            if ((int)(ImageMediaSetType.SameModel) == int.Parse(Request.QueryString["typ"]))
            {
                presenter.GetImageGroupHeader();
                this.addalltolightbox.OnClientClick = "ShowAddToLightboxModal('" + Request.QueryString["id"].ToString() + "', this, false);return false;";
            }
        ...
        #region Implementation of ISameModelHeaderView
