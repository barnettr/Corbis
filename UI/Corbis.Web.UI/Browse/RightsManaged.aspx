<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="RightsManaged.aspx.cs" Inherits="Corbis.Web.UI.Browse.RightsManaged" MasterPageFile="~/Browse/MasterPages/MasterBase.Master" Title="<%$ Resources: windowTitle %>" %>
