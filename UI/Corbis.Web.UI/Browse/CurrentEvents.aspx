<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="CurrentEvents.aspx.cs" Inherits="Corbis.Web.UI.Browse.CurrentEvents" MasterPageFile="~/Browse/MasterPages/MasterBase.Master" Title="<%$ Resources: windowTitle %>" %>
<%@ Register TagPrefix="Corbis" Namespace="Corbis.Web.UI.Controls" Assembly="Corbis.Web.UI.Controls" %>
<%@ Register TagPrefix="Browse" TagName="LeftMenu" src="Controls/BrowseLeftMenu.ascx" %>
<%@ Register TagPrefix="Browse" TagName="ImageSet" src="Controls/ImageSet.ascx" %>
...
<asp:Content ID="historicalContent" runat="server" ContentPlaceHolderID="mainContent">
    <div class="MainColumn">
        ...
        <Browse:ImageSet runat="server" ID="NewsImageSet" PrimaryContentTypeID="683" />
        <Browse:ImageSet runat="server" ID="SportsImageSet" PrimaryContentTypeID="664" />
    </div>
</asp:Content>