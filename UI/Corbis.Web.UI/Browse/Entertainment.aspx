<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Entertainment.aspx.cs" Inherits="Corbis.Web.UI.Browse.Entertainment" MasterPageFile="~/Browse/MasterPages/MasterBase.Master" Title="<%$ Resources: windowTitle %>" %>
...
<asp:Content ID="historicalContent" runat="server" ContentPlaceHolderID="mainContent">
    <div class="MainColumn">
        ...
        <Browse:ImageSet runat="server" ID="EntertainmentImageSet" PrimaryContentTypeID="682" />
    </div>
</asp:Content>