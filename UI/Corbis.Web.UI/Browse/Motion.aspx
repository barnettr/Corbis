<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="Motion.aspx.cs" Inherits="Corbis.Web.UI.Browse.Motion" MasterPageFile="~/Browse/MasterPages/MasterBase.Master" Title="<%$ Resources: windowTitle %>" %>
