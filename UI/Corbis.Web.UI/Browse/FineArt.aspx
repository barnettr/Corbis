<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FineArt.aspx.cs" Inherits="Corbis.Web.UI.Browse.FineArt" MasterPageFile="~/Browse/MasterPages/MasterBase.Master" Title="<%$ Resources: windowTitle %>" %>
