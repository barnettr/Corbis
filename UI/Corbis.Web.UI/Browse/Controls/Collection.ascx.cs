...
namespace Corbis.Web.UI.Browse
{
	public partial class Collection : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			myXSLTransform.xslSource = "~/Browse/xslt/Collection.xslt";
		...
		private string GetXmlPath(string fileName)
		{
			...
			if (fileName.IndexOf("/") <= 0)
			{
				...
				string englishFilePath = "~/Browse/xml/Collections/en-US/" + fileName;
				string languageFilePath = "~/Browse/xml/Collections/" + language + "/" + fileName;
