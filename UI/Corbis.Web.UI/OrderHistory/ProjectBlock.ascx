<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProjectBlock.ascx.cs"
    Inherits="Corbis.Web.UI.OrderHistory.ProjectBlock" %>
<%@ Register TagPrefix="Corbis" Namespace="Corbis.Web.UI.Controls" Assembly="Corbis.Web.UI.Controls" %>
<div id="projectPane" class="orderSummaryPanes">
    <h3>
        <corbis:localize id="project" runat="server" meta:resourcekey="project"></corbis:localize>
        <asp:LinkButton runat="server" ID="editLink" OnClientClick="checkoutTabs.show(0);UpdateBasedOnCurrentTabIndex({tabIndex:0});return false;">Edit</asp:LinkButton>
    </h3>
