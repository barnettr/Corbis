<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentBlock.ascx.cs"
    Inherits="Corbis.Web.UI.Checkout.PaymentBlock" %>
<%@ Register TagPrefix="Corbis" Namespace="Corbis.Web.UI.Controls" Assembly="Corbis.Web.UI.Controls" %>
<div id="paymentPane" class="orderSummaryPanes">
    <hr />
    <h3>
        <corbis:localize id="payment" runat="server" meta:resourcekey="payment" />
        <Corbis:LinkButton runat="server" ID="editLink" OnClientClick="checkoutTabs.show(2);UpdateBasedOnCurrentTabIndex({tabIndex:2});return false;" meta:resourcekey="editLink" />
    </h3>
    <table class="orderSummaryTables t100">
        <thead>
            <tr>
                <th colspan="2" class="leftSection">
                    <corbis:localize id="paymentMethod" runat="server" meta:resourcekey="paymentMethod" />
                </th>
