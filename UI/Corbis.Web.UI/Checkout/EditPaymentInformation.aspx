<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPaymentInformation.aspx.cs" MasterPageFile="~/MasterPages/ModalPopup.Master" Inherits="Corbis.Web.UI.Checkout.EditPaymentInformation" %>
...
<div id="EditPaymentInformationDiv" runat="server" class="editPaymentInformationDiv">
    <div class="titleWrapper">
        <span class="title"><Corbis:Localize ID="creditCardTitleAdd" runat="server" meta:resourcekey="CreditCardTitleAdd" /><Corbis:Localize ID="creditCardTitleEdit" runat="server" meta:resourcekey="CreditCardTitleEdit" /></span>
        <div class="personalCloseButton" id="personalCloseButton">
            <Corbis:Image ID="editPaymentInfoPopupImage" ImageUrl="/Images/iconClose.gif" runat="server" onclick="parent.setCreditCard(null);parent.MochaUI.CloseModal('editPaymentInfoModalPopup');return false;" class="Close" meta:resourcekey="editPaymentInfoPopupImage"/>
        </div>
    </div>
    <div id="addEditCreditCardDiv" class="addEditCreditCardDiv" runat="server">
        ...
        <table cellpadding="1" cellspacing="0" class="tableWidth">
            <tr id="savedCCRow" class="FormRow savedCCRow" runat=server>
                <td class="LeftForm">
                    <Corbis:Label ID="selectACardLbl" runat="server" meta:resourceKey="selectACardLbl" />
                </td>
                <td class=FormRightCreditTop>
                    <Corbis:DropDownList runat="server" ID="creditCardList" CausesValidation="false" AutoPostBack="true" OnSelectedIndexChanged="CreditCardSelected" CssClass="creditCardField" EnableViewState="true"  />
                </td>
            </tr>
            <tr id="defaultCCRow" runat="server" class="FormRow">
                <td class="LeftForm alignLeft fontSize12" colspan="2"><div class="checkLblPair">
            ...
            <tr id="Tr1" class="FormRow" runat=server>
                ...
                <td class=RightFormTd>
                    ...
                    <Corbis:Label runat="server" ID="cardTypeDisplayText" Visible="false" />
                </td>
            </tr>
            <tr id="Tr2" class="FormRow" runat=server>
                ...
                <td class=RightFormTd>
                    <Corbis:TextBox runat="server" ID="cardNumber" MaxLength="16" CssClass="creditCardField" 
                        ...
                        autocomplete="off"                        
                    />
                    <Corbis:Label runat="server" ID="cardNumberDisplayText" />
                </td>
            </tr>
            ...
            <tr id="Tr4" class="FormRow" runat=server>
                ...
                <td class=RightFormTd>
                    <Corbis:TextBox  validate="required" ID="cardHolder" CssClass="creditCardField" runat="server" 
                        EnableViewState="true" 
        ...
        <div class="ButtonRow350">
            ...
            <Corbis:GlassButton runat="server" ButtonStyle="Gray"  ID="cancelBtn" OnClientClick="parent.setCreditCard(null);parent.MochaUI.CloseModal('editPaymentInfoModalPopup');return false;" CssClass="buttonsSpacing"  meta:resourcekey="CancelEditAdd" />
