<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditChinese.ascx.cs" Inherits="Corbis.Web.UI.Accounts.EditChinese" %>
...
<div id="addressDiv" runat="server">
    <asp:UpdatePanel id="countryStateZip" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="FormRight"><Corbis:TextBox ID="zip" runat="server" ValidateControl="true" ValidationObjectType="Corbis.Membership.Contracts.V1.MemberAddress" ValidationRulesetName="CreateMember" ValidationPropertyName="PostalCode" ValidatorContainer="validatorContainer"></Corbis:TextBox></div>
