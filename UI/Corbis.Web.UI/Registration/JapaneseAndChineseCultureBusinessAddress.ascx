<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JapaneseAndChineseCultureBusinessAddress.ascx.cs" Inherits="Corbis.Web.UI.Registration.JapaneseAndChineseCultureBusinessAddress" %>
...
<table class="container">
    ...
    <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         <Corbis:DropDownList class="item" validate="custom1" custom1="validateBusinessCountry()" ID="country" EntityType="Country" custom1_message="<%$ Resources:Accounts, MemberValidationError_BusinessCountryRequired %>" runat="server" />
        </td>
    </tr>
    ...
    <tr class="FormRow" runat="server">
     ...
     <tr class="FormRow" runat="server" >
        ...
        <td class="FormRight">
         ...
         <AJAXToolkit:TextBoxWatermarkExtender BehaviorID="address2BusinessWatermark" WatermarkCssClass="RegistrationOptional" ID="TextBoxWatermarkExtender2" TargetControlID="address2" WatermarkText="<%$ Resources:Resource, Optional %>" runat="server"/>
        </td>
    </tr>
     ...
     <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         ...
         <AJAXToolkit:TextBoxWatermarkExtender BehaviorID="address3BusinessWatermark" WatermarkCssClass="RegistrationOptional" ID="TextBoxWatermarkExtender1" TargetControlID="address3" WatermarkText="<%$ Resources:Resource, Optional %>" runat="server"/>
        </td>
    </tr>
</table>