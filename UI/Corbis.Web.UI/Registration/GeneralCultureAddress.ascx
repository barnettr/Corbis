<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneralCultureAddress.ascx.cs" Inherits="Corbis.Web.UI.Registration.GeneralCultureAddress" %>
...
<table class="container">
    <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         <Corbis:TextBox class="item" validate="required" ID="address1" runat="server" required_message="<%$ Resources:Accounts, MemberValidationError_MailingAddress1Required %>" />
        </td>
    </tr>
     ...
     <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         ...
         <AJAXToolkit:TextBoxWatermarkExtender BehaviorID="address2MailingWatermark" WatermarkCssClass="RegistrationOptional" ID="address2LabelWatermarker"  TargetControlID="address2" WatermarkText="<%$ Resources:Resource, Optional %>" runat="server"/>
        </td>
    </tr>
     ...
     <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         <Corbis:TextBox class="item" ID="address3" runat="server"/>
          <AJAXToolkit:TextBoxWatermarkExtender BehaviorID="address3MailingWatermark" WatermarkCssClass="RegistrationOptional" ID="TextBoxWatermarkExtender1" TargetControlID="address3" WatermarkText="<%$ Resources:Resource, Optional %>" runat="server"/>
        </td>
    </tr>
    ...
    <tr class="FormRow" runat="server">
        ...
        <td class="FormRight">
         <Corbis:DropDownList class="item" validate="custom1" custom1="validateMailingCountry()" custom1_message="<%$ Resources:Accounts, MemberValidationError_MailingCountryRequired %>" ID="country" EntityType="Country"  runat="server" />
        </td>
    </tr>
