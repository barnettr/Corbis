...
var s_account="corbismonarchdev"
...
s.linkInternalFilters="javascript:,corbis.com"
...
function s_doPlugins(s) {
	...
	s.prop12=s.getTimeToComplete(s.prop12,'ttc',30);
	
	/*set page view event*/
	s.events=s.apl(s.events,"event1",",",2)
	
	/*set eVars to s.props*/
	...
	if (s.prop8)	{ s.eVar9=s.prop8;};
	if (s.prop9)	{ s.eVar10=s.prop9;};
	if (s.prop10)	{ s.eVar11=s.prop10;};
	if (s.prop11)	{ s.eVar12=s.prop11;};
}
...
s.trackingServer="metrics.corbis.com"
s.trackingServerSecure="smetrics.corbis.com"
s.dc="122"
