...
function dropdown_menu_hack(el)
{
	...
	if(el.multiple || el.currentStyle.width=="auto"){return;}
	...
	if(window.createPopup==null)
	{
		...
		window.createPopup = function()
		{
			...
			{
			        el.insertAdjacentHTML("BeforeBegin", "<select name='select" + fid + "'>");
	...
	function showMenu()
	{
		...
		mb.style.cssText ="border:solid 1px black;margin:0;padding:0;overflow-y:auto;overflow-x:auto;background:white;text-aligbn:center;font-family:trebuchet ms,sans-serif;font-size:12px;";
