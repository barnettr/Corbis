...
{
    public partial class GlobalNav : CorbisMasterBase
    {
        public Corbis.Web.UI.Navigation.GlobalNav GlobalNav1
        {
        ...
        protected override void OnInit(EventArgs e)
		{
			...
			this.AddScriptToPage("/Scripts/CorporateBase.js", "CorporateBaseScript");
